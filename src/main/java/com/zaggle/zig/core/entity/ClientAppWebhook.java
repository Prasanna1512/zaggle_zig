...
@Entity
@Slf4j
public class ClientAppWebhook {

    @EmbeddedId
    private ClientAppWebhookId clientAppWebhookId;
    private UUID id;
    ...
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JsonIgnoreProperties(value = "appWebhook")
    @JoinColumn(name = "webhook_id", referencedColumnName = "id", insertable = false, updatable = false)
